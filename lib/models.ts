...
export const MODELS = [
  { id: "gpt-5.4-nano", name: "GPT-5.4 Nano", provider: "openai", category: "paid", description: "Fastest and lowest-cost OpenAI option", contextWindow: 400_000, costPer1MToken: { input: 0.2, output: 1.25 } },
  { id: "gpt-5.4-mini", name: "GPT-5.4 Mini", provider: "openai", category: "paid", description: "Higher-quality OpenAI corrections", contextWindow: 400_000, costPer1MToken: { input: 0.75, output: 4.5 } },
  ...
  { id: "gpt-5.5", name: "GPT-5.5", provider: "openai", category: "paid", description: "OpenAI flagship for the highest-quality corrections", contextWindow: 1_000_000, costPer1MToken: { input: 5, output: 30 } },
